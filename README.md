...
<p align="center">
  <b>Handwritten digit (0–9) classification using a Multi-Layer Perceptron (ANN) built with TensorFlow/Keras.</b>
</p>
...
- Transition from traditional machine learning to a deep learning workflow  
- More structured GitHub repository layout  
- More polished README design and explanation  
...
Before training the model, the dataset was prepared as follows:
...
- Training and testing sets were kept separate for fair evaluation  

These steps make the input suitable for dense neural network learning.
...
- Better project structuring on GitHub  
- Improved README design with visuals and sections  
- Clearer storytelling for recruiters and reviewers  
